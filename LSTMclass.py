...
class VariableSequenceClassification:
	...
	def __init__(self, num_hidden=200, num_layers=2):
		...
		self.model_dir = deep_AS_config.FLAGS.rnn_dir + 'model/'
		self.log_dir = deep_AS_config.FLAGS.rnn_dir + 'log/'
		self.prediction
		self.cost
		self.error
		self.optimize
...
# 	image_size = 384
# 	num_classes = 2
# 	dir = "../Z_bysj/data/protein_transgraph_64bp"
